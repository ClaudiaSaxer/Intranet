        ...
        public static List<TestValue> TwoTestValuePerType()
            => new List<TestValue>
            {
                new TestValue
                {
                    TestValueType = TestValueType.Single,
                    ArticleTestType = ArticleType.IncontinencePad,
                    IncontinencePadTestValue = new IncontinencePadTestValue { TestType = TestTypeIncontinencePad.Retention, RetentionRw = RwType.Better },
                ...
                new TestValue
                {
                    TestValueType = TestValueType.Single,
                    ArticleTestType = ArticleType.IncontinencePad,
                    IncontinencePadTestValue = new IncontinencePadTestValue { TestType = TestTypeIncontinencePad.RewetFree, RewetFreeRw = RwType.Better },
                    TestSheet = new TestSheet { MachineNr = "M12" }
                },
                new TestValue
                {
                ...
                new TestValue
                {
                    TestValueType = TestValueType.Average,
                    ArticleTestType = ArticleType.IncontinencePad,
                    IncontinencePadTestValue = new IncontinencePadTestValue { TestType = TestTypeIncontinencePad.Retention, RewetFreeRw = RwType.Better },
                    TestSheet = new TestSheet { MachineNr = "M12" }
                },
                new TestValue
                {
                ...
                new TestValue
                {
                    ...
                    ArticleTestType = ArticleType.IncontinencePad,
                    IncontinencePadTestValue =
                        new IncontinencePadTestValue { TestType = TestTypeIncontinencePad.AcquisitionTimeAndRewet, RewetAfterAcquisitionTimeRw = RwType.Better },
                    TestSheet = new TestSheet { MachineNr = "M12" }
                },
                new TestValue
                {
