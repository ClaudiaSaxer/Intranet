...
namespace Intranet.Labor.Bll.Test
{
    ...
    public class InkoRetentionServiceTest
    {
        ...
        /// </summary>
        [Fact]
        public void GetInkoRetentionEditViewModelWithNoBabyDiaperTestVauleTest()
        {
            var listOfTestValues = new List<TestValue>
            {
        ...
        /// </summary>
        [Fact]
        public void GetInkoRetentionEditViewModelRewetOnlyTest()
        {
            var listOfTestValues = new List<TestValue>
            {
                new TestValue
                {
                    ...
                    IncontinencePadTestValue = new IncontinencePadTestValue {IncontinencePadTime = new TimeSpan(5,10,0), RetentionWeight = 30, RetentionWetValue = 400.2, RetentionAfterZentrifuge = 200 , RetentionAbsorbtion = 380.2, RetentionEndValue = 190, RetentionRw = RwType.Ok, TestType = TestTypeIncontinencePad.Retention}
                }
            };
            var testSheetInDb = new TestSheet
            {
